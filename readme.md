...
***language-add/delete***  
  config file "/config/_default/languages.toml" 

  language info description: 
  1. languageName: It is the languageName in the website language select. 
  2. languageCode: It is the contryFlag code. Please search the country on [ISO 3166-1-alpha-2 code](https://www.iso.org/obp/ui/#search/code/) , then find Alpha-2 code and  make it lowercase.   
  Example:    
  (gr is Greece by searching on [ISO 3166-1-alpha-2 code](https://www.iso.org/obp/ui/#search/code/) of a country)   
  `<span class="fi fi-gr fis"></span>`
  3. contentDir: It is relative content url. That language page should be put in "/content/xx".
  4. weight: It is the sorting basis for languages in the website language select. 
  5. languageUrl: It is relative web url.
   example: 
   languageUrl = "ko-kr"
   http://localhost:1313/ko-kr/  
    
  >After above operation, please add relative file in "/i18n" folder to show the language on page. The fileName must be the sanme with the language.  
  example:  
  [en-us] -- "i18n/en-us.toml"  
  [ja-jp] -- "i18n/ja-jp.toml"  
  [ko-kr] -- "i18n/ko-kr.toml"  


### 👉menu config 
config file "/config/_default/menus.toml"
...
name: menu name  
url: page web url  
wight: menus is sort by it 



### 👉image config 
the image files need to be put  in  "assets/images" folder,
the urls of page pictures are recorded in "data/pageImage.json". 

>#### only banner background-image of home page is special. 
>config-url :"content/[languages]/sections/testimonial"
image need to be put "static/images"
